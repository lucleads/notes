**Learning tests:** (Tests de integración para APIs externas) Estos tests hacen llamadas a APIs o liberías externas y se centran en la respuesta esperada de la API.
